 ...
 * @author hadtt17
 * @since Oct 12, 2016
 * @modified Oct 12, 2016
 * @by hadtt17
 */

public class StopWords {
	public static String[] STOP_WORDS = new String[] { "a", "able", "about", "above", "abst", "accordance", "according",
			...
			"besides", "between", "beyond", "biol", "both", "brief", "briefly", "but", "by", "c", "ca", "came", "can",
			...
			"effect", "egeight", "eighty", "either", "else", "elsewhere", "end", "ending", "enough", "especially", "et",
			...
			"himself", "his", "hither", "home", "how", "howbeit", "however", "hundred", "i", "id", "ie", "if", "i'l",
			"l", "im", "immediate", "immediately", "importance", "importantin", "incindeed", "index", "information",
			"instead", "into", "invention", "inward", "is", "isn't", "it", "itd", "it'l", "l", "its", "itself", "i'v",
			"e", "j", "just", "k", "keep", "keeps", "kept", "kg", "km", "know", "known", "knows", "l", "largely",
			"last", "lately", "later", "latter", "latterly", "least", "less", "lest", "let", "lets", "like", "liked",
			"likely", "line", "little'l", "l", "look", "looking", "looks", "ltd", "m", "made", "mainly", "make",
			...
			"one", "ones", "only", "onto", "or", "ord", "other", "others", "otherwise", "ought", "our", "ours",
			...
			"s", "said", "same", "saw", "say", "saying", "says", "sec", "section", "see", "seeing", "seem", "seemed",
			...
			"than", "thank", "thanks", "thanx", "that", "that'll", "thats", "that've", "the", "their", "theirs", "them",
			...
			"usefully", "usefulness", "uses", "using", "usually", "v", "value", "various've", "very", "via", "viz",
			"vol", "vols", "vs", "w", "want", "wants", "was", "wasnt", "way", "we", "wed", "welcome", "we'll", "went",
